...
from mocap_specs import LEFT_SHOE_SEGMENT, VICON_SCENE
...
left_shoe = scene.subject(ViconSubjectId.LEFT_SHOE).segment(
...
marker_frame = next(iter_vicon_marker_frames(export))
