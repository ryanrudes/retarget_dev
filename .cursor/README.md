...
3. `.cursor/rules/demo-pipeline.mdc`
4. `.cursor/rules/demo-tracks-resampling.mdc`
5. `.cursor/rules/sync-alignment.mdc`
6. `.cursor/rules/testing.mdc`
7. `.cursor/rules/python-style.mdc`
8. `.cursor/rules/running-commands.mdc`
